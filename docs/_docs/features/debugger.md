...
toggle the debugger through the [command palette](/nuclide/docs/editor/basics/#command-palette) and the
Nuclide toolbar.
...
![](/nuclide/static/images/docs/feature-debugger-basics-target-process.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-target-after-attach.png)

### Breakpoints

To set a breakpoint in Nuclide, you use the [gutter](/nuclide/docs/editor/basics#gutter). Click to the left
...
![](/nuclide/static/images/docs/feature-debugger-basics-breakpoints-gutter.png)

In the [main debugging](#basics__debugger) tab of the debugger, you will see what
breakpoints are set as well.

![](/nuclide/static/images/docs/feature-debugger-basics-breakpoints-main-debugging-tab.png)

### Debugger

The main debugging tab is the information control center for the Nuclide debugger.

![](/nuclide/static/images/docs/feature-debugger-basics-main-debugging-tab.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-debugger-watch-menu.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-debugger-breakpoint-menu.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-debugger-detach.png) in the upper-right corner.
...
![](/nuclide/static/images/docs/feature-debugger-basics-debugger-web-inspector.png). This will bring up
...
![](/nuclide/static/images/docs/feature-debugger-basics-debugger-example.png)
...
via the [keyboard](/nuclide/docs/editor/keyboard-shortcuts/#debugger).

![](/nuclide/static/images/docs/feature-debugger-basics-stepping-icons.png)

*Example*

Assume we have a breakpoint set at line 22 of `read.js` (before the call to `processSum()`).

![](/nuclide/static/images/docs/feature-debugger-basics-stepping-example-start.png)

The following shows what happens when you step into the function. We step into the actual
`processSum()` function itself.

![](/nuclide/static/images/docs/feature-debugger-basics-stepping-example-step-in.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-stepping-example-step-over.png)

You can even step into a function that exists in another module.

![](/nuclide/static/images/docs/feature-debugger-basics-stepping-example-start-other-module.png)
...
![](/nuclide/static/images/docs/feature-debugger-basics-evaluation-example.png)
...
- [Hack and PHP](/nuclide/docs/languages/hack/#debugging)
- [Flow and JavaScript](/nuclide/docs/languages/flow/#debugging) (The canonical example for debugging as
  described [above](#basics)).
- [C++](/nuclide/docs/languages/cpp/#debugging)
- [Objective-C](/nuclide/docs/languages/objective-c/#debugging)


## Platform Specific Debugging

- [React Native](/nuclide/docs/platforms/react-native/#debugging)
- [iOS](/nuclide/docs/platforms/ios/#debugging)
- [Android](/nuclide/docs/platforms/android/#debugging)

Buck projects can be more easily debugged via the [Buck toolbar](/nuclide/docs/features/buck#debug).
